...
class SpriteSheet():
    ...
    def find_sprites(self):
                    ...
                    while True:
                        ...
                        try:
                            ...
                            if count == 4:
                                ...
                                dict_label[label_sprite] = [label_sprite]
                            break
        ...
        label_map_width = len(label_map[0])
        ...
        for k in range(label_map_height):
            for a in range(label_map_width):
                if label_map[k][a] in new_dict_lable:
    ...
    def __reduce_label(self, key_dict):
        ...
        while True:
            ...
            if count > 0:
                reverse_order_dict_copy = sorted(key_dict_copy, reverse=True)
                for s in reverse_order_dict_copy:
                    if tuple(key_dict[s]) != tuple(key_dict_copy[s]):
                        break
                    if tuple(key_dict[s]) == tuple(key_dict_copy[s]):
                        if s == reverse_order_dict_copy[-1]:
                            return key_dict
